...
select
	...
	(payments.receita/1000) * 100 as "receita (k, R$)",
...
where
	paid_date between '2021-08-01' and '2021-08-31' -- último mês da base de dados
group by
	país, 
	estado
order by
...
from sales.funnel as fun
	...
	on fun.product_id = prod.product_id
where
	paid_date between '2021-08-01' and '2021-08-31'
group by 
	marca
order by
	"vendas (#)" desc
